...
<div align="center">
        ...
        <table style="width:50%">
            <tr>
                <th><h4>ISBN</h4></th>
                <th><input type="text" size="40" name="ISBN" value="{{ $publications->ISBN }}"</th>
            </tr>
            <tr>
                <th><h4>Názov</h4></th>
                <th><input type="text" size="40" name="title" value="{{ $publications->title }}">
                </th>
            </tr>
            <tr>
                <th><h4>Podnázov</h4></th>
                <th><input type="text" size="40" name="sub_title" value="{{ $publications->sub_title }}"></th>
            </tr>
            <tr>
                <th><h4>Všetci autori</h4></th>
                <th><input type="text" size="40" name="all_authors" value="{{ $publications->all_authors }}"></th>
            </tr>
            <tr>
                <th><h4>Typ</h4></th>
                <th><input type="text" size="40" name="type" value="{{ $publications->type }}"></th>
            </tr>
            <tr>
                <th><h4>Vydavateľ</h4></th>
                <th><input type="text" size="40" name="publisher" value="{{ $publications->publisher }}"></th>
            </tr>
            <tr>
                <th><h4>Počet strán</h4></th>
                <th><input type="text" size="40" name="pages" value="{{ $publications->pages }}"></th>
            </tr>
            <tr>
                <th><h4>Rok vydania</h4></th>
                <th><input type="text" size="40" name="year" value="{{ $publications->year }}"></th>
            </tr>
            <tr>
                <th><h4>Kód</h4></th>
                <th><input type="text" size="40" name="code" value="{{ $publications->code }}"></th>
            </tr>
        </table>
<br> 
<br>

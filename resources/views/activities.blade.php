...
<div align="center">
        ...
        <table style="width:50%">
            <tr>
                <th><h4>ID</h4></th>
                <th><input type="text" size="40" name="ID" value="{{ $activities->ID }}"</th>
            </tr>
            <tr>
                <th><h4>Dátum</h4></th>
                <th><input type="text" size="40" name="date" value="{{ $activities->date }}">
                </th>
            </tr>
            <tr>
                <th><h4>Názov</h4></th>
                <th><input type="text" size="40" name="title" value="{{ $activities->title }}"></th>
            </tr>
            <tr>
                <th><h4>Krajina</h4></th>
                <th><input type="text" size="40" name="country" value="{{ $activities->country }}"></th>
            </tr>
            <tr>
                <th><h4>Typ</h4></th>
                <th><input type="text" size="40" name="type" value="{{ $activities->type }}"></th>
            </tr>
            <tr>
                <th><h4>Kategória</h4></th>
                <th><input type="text" size="40" name="category" value="{{ $activities->category }}"></th>
            </tr>
            <tr>
                <th><h4>Všetci autori</h4></th>
                <th><input type="text" size="40" name="all_authors" value="{{ $activities->all_authors }}"></th>
            </tr>
        </table>
<br> 
<br>

   ...
   public function getview()
    {
        ...
        $user = DB::table('projects')->select('projects.zamestnanec_id','projects.title','projects.year_from', 'projects.reg_number')->where('projects.zamestnanec_id', '=', $autentifikacia->zamestnanec_id)
            ->get();
